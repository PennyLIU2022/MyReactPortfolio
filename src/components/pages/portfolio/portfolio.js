        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            <Col size={12} sm={6} md={4} className="card">
               <PortfolioCard
                  img={Quiz}
                  title="Code Quiz"
                  info="It's a timed coding quiz with multiple-choice questions. This app runs in the browser, and features dynamically updated HTML and CSS powered by JavaScript code. There are five multiple choices and the timer will be started once the user click Start Quiz, ten seconds will be deducted for each wrong answer."
                  ghLink="https://github.com/PennyLIU2022/Code-Quiz"
                  appLink="https://pennyliu2022.github.io/Code-Quiz/"
                />
            </Col>
        </Row>
      </Container>
